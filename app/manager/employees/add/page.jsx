        ...
        <div className="max-w-full mx-auto px-4 py-6 bg-white shadow-lg rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <select
                    ...
                    className="form-select p-3 border-2 border-black rounded-md w-full"
                    required
                >
                ...
                <button type="submit" className="bg-black hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md w-full sm:w-auto">
                    Submit
                </button>
            </form>
        </div>
